...
import { isPackage, type Package } from "./types/Package.js";
import { type DisallowList, isDisallowList } from "./types/DisallowList.js";
...
const { argv } = yargs(hideBin(process.argv))
  ...
  .command(
    "check",
    "Check the package.json doesn't include any disallowed packages",
  )
  // --package
  .alias("p", "package")
  .nargs("p", 1)
